...
export const H1 = ({ hero: heroP, ...props }: any) => (
  <h1 {...props} css={[tw`text-4xl leading-[3rem] text-[var(--head-main)]`, heroP && hero]} />
)
export const H2 = ({ hero: heroP, ...props }: any) => (
  <h2 {...props} css={[tw`text-2xl text-[var(--head-main)] mb-5 md:(text-3xl)`, heroP && hero]} />
)
export const H3 = ({ hero: heroP, ...props }: any) => (
  <h2 {...props} css={[tw`text-xl text-[var(--head-main)] mb-5 md:(text-2xl)`, heroP && hero]} />
)
