...
const BrilliantBlockMaxW800P3 = merge(SnapperBase, {
  cssOut: [tw`min-h-[800px] max-w-[800px]`],
  cssPad: [tw`px-2 sm:px-[5%] md:px-[8%] lg:px-[8%] xl:px-[10%] `],
  cssIn: [tw``],
})
