export const the_count_of_monte_cristo = [
  {
    title: 'Marseille. L’arrivée',
    pages: [
      // page 1
      [
        // pt1
        ...
        `],
        // pt2
        [`Aussitôt, comme d’habitude encore, la plateforme du fort Saint-Jean s’était couverte de
        ...
        s’avançait dans toutes les conditions d’un navire
        parfaitement gouverné : son ancre était en
        mouillage, ses haubans de beaupré décrochés ; et
        près du pilote, qui s’apprêtait à diriger le
        Pharaon par l’étroite entrée du port de Marseille,
        était un jeune homme au geste rapide et à l’œil
  ...
  },
  {
    ...
    pages: [
      ...
      [
        ...
        de l’esplanade de Saint-Jean, de sorte qu’il ne put
        attendre l’entrée du bâtiment dans le port ; il sauta dans une petite barque et ordonna de ramer
        au-devant du Pharaon, qu’il atteignit en face de
        l’anse de la Réserve.
        En voyant venir cet homme, le jeune marin
        quitta son poste à côté du pilote, et vint, le
        chapeau à la main, s’appuyer à la muraille du
        bâtiment.
        `],
        // pt2
        [`C’était un jeune homme de dix-huit à vingt
        ans, grand, svelte, avec de beaux yeux noirs et
        des cheveux d’ébène ; il y avait dans toute sa
        ...
        barque ; qu’est-il donc arrivé, et pourquoi cet air
